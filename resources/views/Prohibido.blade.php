...
<body>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9" role="img">
        ...
        <use xlink:href="#text-s" x="-0.5px" y="-1px" fill="#0091ff"></use> {{--color borde--}}
        <use xlink:href="#text-s" fill="#00b276"></use> {{--color Letras--}}
        <g id="robot">
            <g id="eye-wrap">
    ...
    <h2>Go <a href="{{route('dashboard')}}">Home!</a></h2>
